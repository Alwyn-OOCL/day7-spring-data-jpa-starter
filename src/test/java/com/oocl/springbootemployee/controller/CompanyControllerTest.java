...
class CompanyControllerTest {
    ...
    private void initCompany() {
        acme_corporation = new Company(null, "Acme Corporation", List.of(john_smith, jane_johnson));
        techcom_solutions = new Company(null, "TechCom Solutions", List.of(david_williams, emily_brown, michael_jones));
        global_innovators = new Company(null, "Global Innovators");
        stellar_enterprises = new Company(null, "Stellar Enterprises");
        nexus_industries = new Company(null, "Nexus Industries");
    }

    private void refreshDataRepository() {
        companyRepository.deleteAll();
        companyRepository.flush();
        employeeRepository.deleteAll();
        employeeRepository.flush();
